...
const T = {
  pt: {
    ...
    'macross.sort.label':    'Ordenar',
    'macross.sort.prev':     'Sort anterior',
    'macross.sort.next':     'Próximo sort',
  ...
  en: {
    ...
    'table.macross_gap_up':  (gap) => `↑ gap ${gap}%`,
    'table.macross_gap_down': (gap) => `↓ gap ${gap}%`,
    'macross.sort.label':    'Sort',
    'macross.sort.prev':     'Previous sort',
    'macross.sort.next':     'Next sort',
