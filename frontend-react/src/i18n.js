...
const T = {
  pt: {
    ...
    'ind.desc.ma_crossover':  'MA9 × MA21: escolha o timeframe dos candles (5m, 15m, 1h…) e há quanto tempo cruzou (≤5 min = cruzou nos últimos 5 minutos). São coisas independentes.',
    ...
    'sum.macross':           (p1, iv1, p2, iv2, mode, extra) => `MA${p1}(${iv1}) × MA${p2}(${iv2}): ${mode} ${extra}`,
    ...
    'filter.macross':        (p1, iv1, p2, iv2, mode, extra, sigIv) => `MA${p1}(${iv1}) × MA${p2}(${iv2}): ${mode} ${extra} [${sigIv}]`,
    ...
    'macross.mixed_intervals': 'Intervalos diferentes por MA',
    'macross.label.candles':   'Candles das MAs',
    'macross.label.age':       'Cruzou há',
    'macross.add_age':         'Adicionar janela temporal',
    'macross.remove_age':      'Remover',
    'macross.tip.candle_iv':   'Em qual timeframe as MAs são calculadas (5m, 15m, 1h…). Independente de “cruzou há”.',
    ...
    'macross.tip.proximity':   'Distância máxima entre as MAs (% da MA lenta) — atualiza em tempo real',
    'macross.tip.iv1':         'Intervalo da MA rápida',
    'macross.tip.iv2':         'Intervalo da MA lenta',
    'macross.tip.ma1':         'MA rápida (período menor, ex: 9)',
    'macross.tip.ma2':         'MA lenta (período maior, ex: 21 ou 200)',
    'macross.tip.mode':        'Cruzou = já cruzou (filtra por tempo). Prestes = gap encolhendo, ainda não cruzou.',
  ...
  en: {
    ...
    'ind.desc.ma_crossover':  'MA9 × MA21: pick MA candle timeframe (5m, 15m, 1h…) and how long ago it crossed (≤5 min = within last 5 minutes). These are independent.',
    ...
    'macross.age.240':         '≤ 4 h',
    'macross.age.1440':        '≤ 24 h',
    'macross.mixed_intervals': 'Different interval per MA',
    'macross.label.candles':   'MA candles',
    'macross.label.age':       'Crossed ago',
    'macross.add_age':         'Add time window',
    'macross.remove_age':      'Remove',
    'macross.tip.candle_iv':   'Timeframe where MAs are calculated (5m, 15m, 1h…). Separate from “crossed ago”.',
    'macross.tip.ma1':         'Fast MA (shorter period, e.g. 9)',
    'macross.tip.ma2':         'Slow MA (longer period, e.g. 21 or 200)',
    ...
    'macross.tip.iv1':         'Fast MA interval',
    'macross.tip.iv2':         'Slow MA interval',
