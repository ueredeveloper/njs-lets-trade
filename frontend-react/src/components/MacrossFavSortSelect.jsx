...
export default function MacrossFavSortSelect({ value, onChange, className = '' }) {
  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        className="inline-flex items-center justify-center text-[10px] font-semibold leading-none text-p5/90 whitespace-nowrap min-w-[4.5rem] max-w-[7rem] truncate px-1 h-full hover:text-p5"
