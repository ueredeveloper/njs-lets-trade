async function createMovingAverageFilter(array, intervals, acronym, condictionCallback, addFilter) {
...
function movingAverageAboveCandleClose(lastMovingAverage, lastCandlestick) {
    ...
    return lastMovingAverage > lastCandlestick.close || percentageDifference <= 1.51;
}
