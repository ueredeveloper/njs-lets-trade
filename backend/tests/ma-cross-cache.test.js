...
describe('maCrossCache — candle interval ≠ temporal age', () => {
  ...
  test('buildSnapshotForPreset gera nomes corretos', () => {
    const s5 = buildSnapshotForPreset(CACHED_PRESETS[0], 1_700_000_000_000);
    const s15 = buildSnapshotForPreset(CACHED_PRESETS[1], 1_700_000_000_000);
  ...
  test('CACHED_PRESET keys', () => {
    expect(CACHED_AGE_MIN).toEqual(['5m|5', '15m|5']);
