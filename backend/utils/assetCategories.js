/**
 * Classificação de pares spot em categorias especiais.
 * Um símbolo pode pertencer a mais de uma categoria.
 */
...
/** Tokens UP/DOWN alavancados da Binance e similares */
...
/** Bases que começam com W mas NÃO são wrapped */
...
const DEFAULT_ASSET_DISPLAY = Object.fromEntries(
...
function loadAssetDisplay() {
  if (typeof localStorage === 'undefined') return { ...DEFAULT_ASSET_DISPLAY };
  try {
...
function saveAssetDisplay(assetDisplay) {
