...
function evaluateEntrySignal(config, cMap) {
  ...
  // Níveis vigentes (lower2/lower1/vwap/upper1/upper2) no último candle fechado — usado no
  // cálculo de bandDistPct abaixo (distância real de agora, não a do candle da reconquista).
